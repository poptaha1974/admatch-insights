    ...
    <aside className="hidden md:flex w-64 shrink-0 flex-col border-l border-sidebar-border bg-sidebar h-screen sticky top-0">
      <div className="px-5 py-5 border-b border-sidebar-border">
        <div className="flex items-center gap-2">
          <div className="size-9 rounded-lg bg-gradient-to-br from-primary to-primary/60 grid place-items-center text-primary-foreground font-bold">A</div>
          <div>
            ...
            >
              ...
              {it.badge && (
                <span className={`text-[10px] px-1.5 py-0.5 rounded ${
                  it.badge === "AI" ? "bg-primary text-primary-foreground" : "bg-muted text-muted-foreground"
                }`}>{it.badge}</span>
              )}
            </Link>
          );
      ...
      <div className="p-3 border-t border-sidebar-border">
        <div className="rounded-lg bg-card border border-border p-3 flex items-center gap-3">
          <div className="size-9 rounded-full bg-gradient-to-br from-primary/60 to-primary/30 grid place-items-center text-sm font-bold">إ</div>
